    ...
    <Container fluid="md" className="text-center">
      ...
      <div>
        <a href="/Resume.pdf" target="_blank" rel="noopener noreferrer" className="px-2">
          <img src={Res} width="65em" height="65em" alt="Email social media icon" />
        </a>
        <a href="mailto:aplank14@gmail.com" target="_blank" rel="noopener noreferrer" className="px-2">
          <img src={Email} width="65em" height="65em" alt="Email social media icon" />
        </a>
        <a href="https://github.com/Aplank14" target="_blank" rel="noopener noreferrer" className="px-2">
          <img src={Github} width="65em" height="65em" alt="Github social media icon" />
        </a>
        <a href="https://www.linkedin.com/in/andy-plank" target="_blank" rel="noopener noreferrer" className="px-2">
          <img src={LinkedIn} width="65em" height="65em" alt="Github social media icon" />
        </a>
      </div>
    </Container>
  </div>
